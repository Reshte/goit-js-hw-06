...
// Elements: 5
// Решение:
// 1. получить ссылку на все элементы списка, должен прийти псевдомассив.(element.querySelectorAll(selector);)
// 2. Перебрать псведомассив forEach
// 3. Законсолить необходимые данные
